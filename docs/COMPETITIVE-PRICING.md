...
| **Chutes (SN64)** | Chutes | Inference / subscription endpoints (the consumer of SN90 in the loop) | Chutes API — per-token and subscription inference pricing | Bittensor metagraph — SN64 emission share, EMA price |
