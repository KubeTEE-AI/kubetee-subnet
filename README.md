...
Current buyer models: `z-ai/glm-5.2` (`glm-5.2`), `z-ai/glm-5.3`, `z-ai/glm-5.3-flash`, and `ornith/ornith-1.5-397b` (first worldwide availability, 2026-08-20). Discounts are **dynamic** — set automatically against the live market, never pinned in docs ([SN28-SAYGM.md](./docs/SN28-SAYGM.md)).
...
- [x] **SN28 (sayGM) idle-capacity channel + LiteLLM inference provider** — live 2026-08-19 ([SN28-SAYGM.md](./docs/SN28-SAYGM.md)). SN90 is **not** an inference subnet; Factory AI services keep priority; SN28 gets spare headroom. Same `model` names on `llm.kubetee.ai`. Buyer offers: `z-ai/glm-5.2`, `z-ai/glm-5.3`, `z-ai/glm-5.3-flash`, `ornith/ornith-1.5-397b` — discounts dynamic. `deepseek/deepseek-v4-flash-0731` withdrawn from SN28 on 2026-08-27; `qwen/qwen3.8-flash-next` withdrawn 2026-09-04 (license). **Ornith-1.5-397B** — first worldwide availability, in collaboration with SN28 sayGM (2026-08-20). Free window closed at 14,812,329,857 tokens.
...
- [SN28 sayGM — idle-capacity channel](./docs/SN28-SAYGM.md) — live 2026-08-19; LiteLLM inference provider; TEE fallbacks (Chutes / Phala / Near AI); dynamic pricing; first worldwide Ornith-1.5-397B with SN28 (2026-08-20)
